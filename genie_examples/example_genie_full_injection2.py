...
def main():
    ...
    config["run"]["outfile"] = f"{OUTPUT_DIR}/final_out_{num_events}_events_1_to_100gev_simset_{simset}_seed_{seed_num}_upgrade_internal_leif_fixed_omap_{timestamp}_OMSim_tables_leif_comparable_for_real_new_geo_with_photons.parquet"
