...
def main():
   ...
   # output_dir = f"/groups/icecube/jackp/prometheus_genie_cleaned/harvard-prometheus/examples/output"
    primrary_file_path = f'{OUTPUT_DIR}/genie_events_primary_new_test_1_to_100gev_simset_{simset}_nevents_{num_events}_seed_{seed_num}_upgrade_doms_only_new_loss.parquet'
    prometheus_file_path = f'{OUTPUT_DIR}/genie_events_prometheus_new_test_1_to_100gev_{simset}_nevents_{num_events}_seed_{seed_num}_upgrade_doms_only_new_loss.parquet'
